...
function createSelectedFlowerScene(){
    ...
    //create the lights
    let light = new BABYLON.HemisphericLight("selectedFlowersLight", new BABYLON.Vector3(-50, 100, -50), selectedFlowerScene);
    // let light2 = new BABYLON.HemisphericLight("earthFlowersLight2", new BABYLON.Vector3(0, -5, -10), selectedFlowerScene);
    light.radius = 300;
    // light2.radius = 300;
    light.intensity = 1.2;
...
function create_selected_flower_camera(){
  //create the camera
    ...
    selectedFlowerCamera.upperRadiusLimit = 200;
...
function load_earth_with_flowers_mesh(){
    Promise.all([
        BABYLON.SceneLoader.ImportMeshAsync(null, "front/objects/flowersMbayeScene/", "nuvolaCarpet.glb", selectedFlowerScene).then(function (result) {
            ...
            // result.meshes[8].name = "nuvolaCountries";
        ...
        // BABYLON.SceneLoader.ImportMeshAsync(null, "front/objects/flowersMbayeScene/nuvola/", "nuvolaCarpet2.babylon", selectedFlowerScene).then(function (result) {
            
        //     nuvola_obj = result.meshes[1];
        //     nuvola_obj.isPickable = true;
        //     nuvola_obj.scaling = new BABYLON.Vector3(0.07,0.07,0.07);
        //     // result.meshes[8].name = "nuvolaCountries";
        //     // result.meshes[8].isVisible = false;
        ...
        BABYLON.SceneLoader.ImportMeshAsync(null, "front/objects/designScene/cloud/", "speechCloud.glb", selectedFlowerScene).then(function (result) {
            ...
            mermaidSpeechCloud.scaling = new BABYLON.Vector3(8,8,-8);
        ...
        BABYLON.SceneLoader.ImportMeshAsync(null, "front/objects/flowersMbayeScene/cloud/", "flowersNuvola1.glb", selectedFlowerScene).then(function (result) {
            result.meshes[0].scaling = new BABYLON.Vector3(17,17,-17);
...
function create_orig_flower(){
    ...
    plane.position = new BABYLON.Vector3(-115.44,38.76, 49.62);
...
function set_orig_flower(theFlowerName){
    ...
    //ADD GROWING ANIMTION TO THE FLOWER
        ...
        selectedFlowerScene.beginAnimation(chosenFlower, 0, 100, true);
        //END OF ANIMATION
