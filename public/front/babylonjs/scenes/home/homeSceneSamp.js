...
function init_texts(){
    ...
    let solar = BABYLON.MeshBuilder.CreatePlane("Solar Plane", {width:957, height: 782}, homeScene);
    solar.position = new BABYLON.Vector3( 1242.73,-2249,449.96);
    solar.rotationQuaternion = new BABYLON.Quaternion(-0.0402,-0.8012, 0.1478,  -0.5779);
   ...
   solarMatl.opacityTexture = new BABYLON.Texture("front/images3D/homeScene/solarSitting2.png", homeScene);
    ...
    plane.position = new BABYLON.Vector3(115.78,-2338.68,-641.70);
    plane.rotationQuaternion = new BABYLON.Quaternion(0.07504,0.9082, -0.1216,0.3931);
