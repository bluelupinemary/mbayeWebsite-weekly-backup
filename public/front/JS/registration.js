...
/*  $('#btn_Register').click(function(){
  ...
  $('#div').click(function(){
      ...
      $(".asrtonaut_animation_div ").removeClass("img_astro");
  ...
  function calculate_age()
  {
    ...
    */
    ...
    // IF THE ORAGANIZATION TYOE IS INDIVIDUAL START
    $("#org_types").change(function(){
      org_name = $(this).val();
      if(org_name == "Individual")
      {
        $('#org_name').val('N/A');
        $('#org_name').prop('readonly',true);
      }  
    });
    // IF THE ORAGANIZATION TYOE IS INDIVIDUAL END
    // CHECK IF THE EMAIL IS VALID OR NOT VALID START
    $('#Email').change(function(){
      ...
      else
      {
        ...
        $.ajax({
          ...
          success: function(responce) {
            ...
            {
              custom_swal("Already Exist!","login to your account","Email");
              $('#Email').removeClass('success-alter');
              $('#Email').addClass('danger-alter');
              $('#Email').tooltip();
              $('#Email').focus();
    ...
    // CHECK IF THE EMAIL IS VALID OR NOT VALID ENDS
    ...
    */
    ...
    $(".next").click(function(){
      ...
      if (current_fs.attr('attr-tab-id') == 1) 
      {
        ...
        // var test = text_map.get(1)
        // $('#registerText').html(test);
      ...
      var res = text_map.get(parseInt(current_fs.attr('attr-tab-id')));
      console.log(res, current_fs.attr('attr-tab-id'));
      $('#registerText').html(res);
      $('#registerText').hide();
    ...
    $(".previous").click(function(){
      ...
      // var res = text_map.get(parseInt(current_fs.attr('attr-tab-id')));
      // console.log(res, current_fs.attr('attr-tab-id'));
      var pre = text_map.get(parseInt(current_fs.attr('attr-tab-id'))-2);
      console.log(parseInt(current_fs.attr('attr-tab-id')), pre);
      $('#registerText').html(pre);
      $('#registerText').hide();
    });
