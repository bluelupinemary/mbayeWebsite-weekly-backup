...
@section ('title', trans('labels.backend.designblogs.management'))

@section('page-header')
    <h1>{{ trans('labels.backend.designblogs.management') }}</h1>
@endsection

@section('content')
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.designblogs.management') }}</h3>
    ...
    <script>
        $(function() {
            ...
            var dataTable = $('#blogs-table').dataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route("admin.designblogs.get") }}',
                    type: 'post'
                },
                columns: [
