...
@section ('title', trans('labels.backend.access.users.management') . ' | ' . trans('labels.backend.access.users.featured'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.access.users.management') }}
        <small>{{ trans('labels.backend.access.users.featured') }}</small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.access.users.featured') }}</h3>
        ...
        (function () {
            ...
            var dataTable = $('#users-table').dataTable({
                ...
                ajax: {
                    ...
                    type: 'post',
                    data: {status: 1, trashed: false, featured:true}
                },
                columns: [
