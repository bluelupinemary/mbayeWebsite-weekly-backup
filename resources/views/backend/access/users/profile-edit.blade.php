...
@section('content')
	{{ Form::model($logged_in_user, ['route' => 'admin.profile.update','files'=> true , 'class' => 'form-horizontal', 'method' => 'PATCH']) }}
     ...
     <div class="box box-info">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                    {{ Form::label('photo', 'Profile Image', ['class' => 'col-lg-2 control-label']) }}

                    <div class="col-lg-10">
                            <input type="file" class="form-control box-size inputfile inputfile-1" name="photo">
                        {{-- <div class="img-remove-logo">
                            @if(access()->user()->photo)
                            <img height="50" width="50" src="{{ asset('uploads/profileimages/'.access()->user()->photo) }}">
                            <i id="remove-logo-img" class="fa fa-times remove-logo" data-id="logo" aria-hidden="false"></i>
                            @endif
                        </div> --}}
                    </div>
                    <!--col-lg-10-->
