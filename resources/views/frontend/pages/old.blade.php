...
@section('content')
    ...
    <div class="communicator">
     ...
     <!----->
        <button type="button" class="exit-fullscreen">
...
$(' .fullscreen span').click(function() {
   ...
   // alert("dd");
    //$('.text-editor-fullview trix-editor').html($('.trix-editor trix-editor').html());
    //$('.text-editor-fullview').fadeIn();
});

// hide fullscreen trix editor
$('.exit-fullscreen').click(function() {
   // $('.trix-editor trix-editor').html($('.text-editor-fullview trix-editor').html());
   // $('.text-editor-fullview').fadeOut();
});
