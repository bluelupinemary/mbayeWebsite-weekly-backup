    ...
    <section class="container-fluid" style="height:100vh">
        <div class="sub_container" style="border:0px solid white">
          <div id="overlay"></div>
                  ...
                  @endif
          {{ Form::open(['route' => 'frontend.user.profile.update','files'=>true , 'class' => 'form-horizontal form_details', 'method' => 'PATCH', 'id'=>'MyForm','onsubmit' => 'event.preventDefault(); validateMyForm();']) }}
              ...
              <div class="col-lg-4 col-xl-3 col-sm-4  col-md-4 col-12  border1">
                  <div class="row border1">
                      ...
                      <div class="col-lg-8 col-xl-8 col-sm-7 col-md-7 col-6 border1" >
                          <input class="form-control lbl_text" id="date" name="dob" placeholder="MM/DD/YYYY" type="date" value="{{ old('dob') }}" onchange="calculate_age()"/>
                      </div>
          ...
          <div class="row  border1">
              ...
              <div class="col-lg-4  col-xl-3 col-sm-4 col-md-4 col-12 border1 ">
                  <div class="row border1">
                      ...
                      <div class="col-lg-8 col-xl-8 col-sm-7 col-md-7 col-6 border1" >
                          <select name="gender" class=" mb-3 form-control lbl_text" id="genders">
          ...
          <div class="row  border1">
              ...
              <div class="col-lg-4 col-xl-3 col-sm-4 col-md-4 col-12 border1" >
                  <div class="row border1">
                      ...
                      <div class="col-lg-8 col-xl-8 col-sm-7  col-md-7 col-6  border1" >
                          <input type="text" class="form-control lbl_text" type="text" id="id_number" value="{{ old('id_number') }}" name="id_number"/>
                      </div>
                  </div>
              </div>
          ...
          <div class="row  border1 ">
              ...
              <div class="col-lg-4  col-xl-3 col-sm-4 col-md-4  col-12 border1">
                  <div class="row border1">
                      ...
                      <div class="col-lg-8 col-xl-8 col-sm-7  col-md-7 col-6 border1" >
                          <input type="text" class="form-control lbl_text" id="username" value="{{ old('username') }}" name="username"/>
                      </div>
                  </div>
              </div>
         ...
         <!-- <div class="camborder1">   </div>  -->
          ...
          <input type="hidden" class="form-control scrollbar scrollbar-info txt_occup"  disabled='disabled' id="occupation_text_area" name="occupation">
          <!------Occupation ends---->
