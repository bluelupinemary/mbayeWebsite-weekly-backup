...
<style>
    .blog-heading, .blog-content, .blog-comments {
        background: #145e4747;
    }
        ...
        <div class="single-blog">
            <div class="blog-heading">
                ...
                <div class="blog-details-1">
                    ...
                    <div class="blog-dates-reactions">
                        <div class="blog-dates">
                            <p class="day">
                                {{ Carbon\Carbon::parse($shared_blog->publish_datetime)->format('d') }}
                            </p>
                            <p class="month">
                                {{ Carbon\Carbon::parse($shared_blog->publish_datetime)->format('F').', '.Carbon\Carbon::parse($shared_blog->publish_datetime)->format('Y') }}
                            </p>
                            <p>
                                {{ Carbon\Carbon::parse($shared_blog->publish_datetime)->format('h:i A') }}
                            </p>
                        </div>
                ...
                <div class="blog-details">
                    ...
                    <div class="owner-names">
                        <span
                        class="blog-owner shared-by">Shared by: {{ $shared_blog->owner->first_name.' '.$shared_blog->owner->last_name }}
                        </span>
                        <span
                            class="blog-owner">Owned by: {{ $blog->owner->first_name.' '.$blog->owner->last_name }}
                        </span>
                    </div>
                    <hr>
            ...
            <div class="blog-body">
                ...
                <div class="blog-content">
                    ...
                    @if($shared_blog->blog_type == 'App\Models\Blogs\Blog' && $blog->isDesignsBlog())
...
@endsection
    ...
    <script>
        ...
        var shared_blog = {!! json_encode($shared_blog->toArray()) !!};
        ...
        $(document).ready(function() {
            ...
            // init();
            // console.log(blog);
            $('.blog-summary .content').html(trimHtml(shared_blog.caption, { limit: 200 }).html);
