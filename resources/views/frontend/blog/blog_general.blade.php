                ...
                <div class="carousel-inner col-md-12">
                    ...
                    <div class="item active">
                     ...
                     {{-- <div class="item">
                        ...
                        <div class="col-xs-4">
                            <a href="#1">
                                <img src=""  id="5" class="img-responsive">
                            </a>
                        </div>
                        <div class="col-xs-4">
                            <a href="#1">
                                <img src=""  id="6" class="img-responsive">
                            </a>
                        </div>
                      </div> --}}
{{--                       
                ...
                <a class="left carousel-control" href="#theCarousel" data-slide="prev" onclick="go_to_previous()"><i class="glyphicon glyphicon-chevron-left arrow"></i></a>
                <a class="right carousel-control" href="#theCarousel" data-slide="next" onclick="go_to_next()"><i class="glyphicon glyphicon-chevron-right arrow"></i></a>
              </div>
            </div>
          </div>
...
@section('after-scripts') 
  ...
  <script type="text/javascript">
    ...
    var arrCount = [
     {
        'id': '1', 'name': '1', 'thumb': '/storage/img/blog/1591438745workshop.jpg', 'naffcount': '400' 
		
    },
    {
        'id': '2', 'name': '2', 'thumb': '/storage/img/blog/1591017265a46.jpg', 'naffcount': '200' 
		
    },
    {
        'id': '3', 'name': '3', 'thumb': '/storage/img/blog/1591438556a2.jpg', 'naffcount': '150' 
		
    },

    {
        'id': '4', 'name': '4', 'thumb': '/storage/img/blog/1587381503a8.jpg', 'naffcount': '100' 
		
    },
  {
        'id': '5', 'name': '5', 'thumb': '/storage/img/blog/1590997811a12.JPG', 'naffcount': '80' 
		
    },
    {
        'id': '6', 'name': '6', 'thumb': '/storage/img/blog/1591438590a1.jpg', 'naffcount': '50' 
		
    },
     {
        'id': '7', 'name': '7', 'thumb': '/storage/img/blog/1591438711a12.jpg', 'naffcount': '20' 
		
    },
    {
        'id': '8', 'name': '8', 'thumb': '/storage/img/blog/1591017222a51.jpg', 'naffcount': '5' 
...
//console.log(arrCount.length);
    for(let j = 0; j < arrCount.length; j++) {
        //console.log("here")
       // $('<div class="item"><div class="col-xs-4"> <a href="#1"><img class="img-responsive" src="'+arrCount[i].thumb+'" >   </a></div></div>').appendTo('.carousel-inner');
...
$("#1").attr("src",arrCount[0].thumb);
$("#2").attr("src",arrCount[1].thumb);
$("#3").attr("src",arrCount[2].thumb);
// $("#4").attr("src",arrCount[3].thumb);
// $("#5").attr("src",arrCount[4].thumb);
// $("#6").attr("src",arrCount[5].thumb);
...
$("#1").attr("src",arrCount[3].thumb);
$("#2").attr("src",arrCount[4].thumb);
$("#3").attr("src",arrCount[5].thumb);
