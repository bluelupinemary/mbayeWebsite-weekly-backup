...
@section('after-scripts') 
  ...
  <script type="text/javascript">
    ...
    var arrCount = {
    '0' : {
        'nHot_Count': '2000', 'nCool_Count': '400', 'nNaff_Count': '67', 'nComment_Count': '800' 
		
    },
    '1' : {
        'nHot_Count': '500', 'nCool_Count': '1000', 'nNaff_Count': '90', 'nComment_Count':'10'
    },
	'2' : {
		'nHot_Count': '190', 'nCool_Count': '90', 'nNaff_Count': '555', 'nComment_Count': '5'
    },
	'3' : {
		'nHot_Count': '0', 'nCool_Count': '0', 'nNaff_Count': '0', 'nComment_Count': '0'
    },
	'4' : {
		'nHot_Count': '56', 'nCool_Count': '678', 'nNaff_Count': '400', 'nComment_Count':'104' 
    },
	'5' : {
        'nHot_Count': '390', 'nCool_Count': '90', 'nNaff_Count': '555', 'nComment_Count': '5' 
		
    },
    '6' : {
		'nHot_Count': '678', 'nCool_Count': '45', 'nNaff_Count': '5', 'nComment_Count': '5'
    },
	'7' : {
		'nHot_Count': '54', 'nCool_Count': '3445', 'nNaff_Count': '43', 'nComment_Count':'4' 
    },
    '8' : {
        'nHot_Count': '100', 'nCool_Count': '190', 'nNaff_Count': '555', 'nComment_Count': '5' 
    },
    '9' : {
		'nHot_Count': '344', 'nCool_Count': '244', 'nNaff_Count': '44', 'nComment_Count': '4' 
    },
    '10' : {
		'nHot_Count': '1555', 'nCool_Count': '776', 'nNaff_Count': '555', 'nComment_Count':'10'
    },
    '11' : {
        'nHot_Count': '500', 'nCool_Count': '1000', 'nNaff_Count': '90', 'nComment_Count':'10'
    },
	'12' : {
		'nHot_Count': '910', 'nCool_Count': '90', 'nNaff_Count': '50', 'nComment_Count': '5'
    },
	'13' : {
		'nHot_Count': '501', 'nCool_Count': '200', 'nNaff_Count': '30', 'nComment_Count': '800'
    },
	'14' : {
		'nHot_Count': '56', 'nCool_Count': '678', 'nNaff_Count': '40', 'nComment_Count':'104' 
    },
	'15' : {
        'nHot_Count': '90', 'nCool_Count': '300', 'nNaff_Count': '555', 'nComment_Count': '5' 
	...
	'20' : {
		'nHot_Count': '190', 'nCool_Count': '90', 'nNaff_Count': '5', 'nComment_Count': '5'
    },
	'21' : {
		'nHot_Count': '0', 'nCool_Count': '0', 'nNaff_Count': '0', 'nComment_Count': '0'
    },
	'22' : {
		'nHot_Count': '56', 'nCool_Count': '678', 'nNaff_Count': '3', 'nComment_Count':'104' 
    },
	'23' : {
        'nHot_Count': '390', 'nCool_Count': '90', 'nNaff_Count': '7', 'nComment_Count': '5' 
...
function contentDisplay() { 
  ...
  //adjusting translation animation
    ...
    else if(navigator.userAgent.indexOf("Firefox") != -1 ) 
    {
        ...
        var currentMatrix = new MoZCSSMatrix(document.defaultView.getComputedStyle(dolly, null).MozTransform);
        var targetMatrix = new MoZCSSMatrix(dolly.style.MozTransform);
        var dx = currentMatrix.e - targetMatrix.e;
        var angle = Math.min(Math.max(dx / (CXSPACING * 3.0), -1), 1) * 45;
...
if(arrCount[reln]['nHot_Count']!==null){
    nHot_Count=arrCount[reln]['nHot_Count'];
}
else
nHot_Count=100;


if(arrCount[reln]['nCool_Count']!==null){
    nCool_Count=arrCount[reln]['nCool_Count'];
}
else
nCool_Count=200;


if(arrCount[reln]['nNaff_Count']!==null){
    nNaff_Count=arrCount[reln]['nNaff_Count'];
}
else
nNaff_Count=200;

if(arrCount[reln]['nComment_Count']!==null){
    nComment_Count=arrCount[reln]['nComment_Count'];
}
else
nComment_Count=200;
//change background color based on largeset count
    ...
    $(".div_counts_"+i).css({'display':'none',width:width, height:height,
        ...
        largest(nHot_Count,nCool_Count,nNaff_Count,i);
          ...
          $(".div_count_bg"+i).css({"position":"absolute","width":width,
                                                    ...
                                                    "height":height,"top":top,"left":left,'opacity':'35%'});
   ...
   // console.log(newcell+"-"+cells.length)
...
*/
    ...
    /* scroll check */
       ...
       /*   Hammer.js  */
            ...
            var myBlock = document.getElementById('page');
...
function play_note(id){
    ...
    if(naffCount==555){
        var audio = document.getElementById("fart");
            ...
            $(".img-nouvela").removeClass("ani-rollout_naff");
            $(".img-nouvela").css({'display':'block','z-index':'100000'});
