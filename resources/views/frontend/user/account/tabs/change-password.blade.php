                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="row border1">
                                        <div class="button-passreset-div">
                                            {{ Form::submit(trans('labels.general.buttons.update'), ['class' => 'btn btn-primary btn-info btn_passreset', 'id' => 'change-password']) }}
                                        </div>
                                    </div>
                                </div>
                        {{ Form::close() }}
...
@section('after-scripts')
    <script>
        ...
        if(message)
              ...
              /*$(".btn_passreset").click(function(){

                    var emessage='All of the fields are required';
                    var title = 'Error!';
                   if($(".txt_email").val()==''){
                    Swal.fire({
                                title: title,
