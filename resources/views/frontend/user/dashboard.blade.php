...
<div id="page-content">
    ...
    <div class="planets ">
        ...
        <div class="zoom-in-planet img_neptune">
            <img src="{{asset('front/images/planets/neptune.png')}}">
        ...
        <div class="zoom-in-planet img_jupiter">
            <img src="{{asset('front/images/planets/jupiter.png')}}">
        ...
        <div class="zoom-in-planet img_moon">
            <img src="{{asset('front/images/planets/moon-w.png')}}">
        ...
        <div class="zoom-in-planet img_mercury">
            <img src="{{asset('front/images/planets/Mercury.png')}}">
