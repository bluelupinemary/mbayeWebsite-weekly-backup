                                  ...
                                  <button type="button"  class="close remove-btn-workexperience"   title="Remove Work Experience "aria-label="Clone" onclick="remove_work_experience(this)">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6 input-group-sm">
                                          ...
                                          <input type="date" class="form-control" id="start_date" value="{{ strftime('%Y-%m-%d',strtotime($workExperience['start_date'])) }}" name="start_date[]" >
                                        </div>
                                        <div class="form-group col-md-6 input-group-sm">
                                          <label for="EndDate">End Date<span style="color:red">*</span></label>
                                          <input type="date" class="form-control" value="{{ strftime('%Y-%m-%d',strtotime($workExperience['end_date'])) }}" id="end_date" name="end_date[]" >
                                        </div>
                                      </div>
                                        <div class="form-group input-group-sm">
                                            <label for="CompName">Company Name<span style="color:red">*</span></label>
                                            <input type="text" class="form-control" id="company_name" name="company_name[]" value="{{ $workExperience->company_name ?? '' }}" placeholder="">
                                        </div>
                                      <div class="form-group input-group-sm">
                                        <label for="CompRole">Role<span style="color:red">*</span></label>
                                        <input type="text" class="form-control" id="CompRole" name="role[]" value="{{ $workExperience->role ?? '' }}" placeholder="">
                                      </div>
                                      <div class="form-group input-group-sm">
                                        <label for="CompDesig">Designation<span style="color:red">*</span></label>
                                        <input type="text" class="form-control" id="CompDesig" name="designation[]" value="{{ $workExperience->designation ?? '' }}" placeholder="">
                                      </div>
                                      <div class="form-group input-group-sm">
                                        <label for="Contact">Contact<span style="color:red">*</span></label>
                                        <input type="text" class="form-control" id="Contact" name="contact_no[]" value="{{ $workExperience->contact_no ?? '' }}" placeholder="">
                                      </div>
                                      <div class="form-group input-group-sm">
                                        <label for="Address">Address<span style="color:red">*</span></label>
                                        <input type="text" class="form-control" id="Address" name="address[]" value="{{ $workExperience->address ?? '' }}" placeholder="">
                                      </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12 input-group-sm" id="education_dropdown">
                                            <label for="education_level">Level Of  Education<span style="color:red">*</span></label>
                                                ...
                                                <option value="{{ $education->education_level ?? '' }}" selected disabled>{{ $education->education_level ?? '' }}</option>
                                      ...
                                      <div class="form-group col-md-12 input-group-sm">
                                        ...
                                        <input type="text" class="form-control" id="FieldOfStudy"  name="field_of_study" value="{{ $education->field_of_study ?? '' }}" required>
                                      </div>
                                      <div class="form-group col-md-12 input-group-sm">
                                        <label for="Description">Description<span style="color:red">*</span></label><br>
                                        <textarea id="Description" name="description" required> {{ $education->description ?? '' }}</textarea>
                                      </div>
                                        <div class="form-group col-md-4 input-group-sm">
                                          <label for="StartDate" style="">Start Date<span style="color:red">*</span><span></span></label>
                                          <input type="date" class="form-control" id="StartDate" placeholder="Date" value="{{ strftime('%Y-%m-%d',strtotime($education['start_date'])) }}"  name="start_date" required >
                                        </div>
                                        <div class="form-group col-md-4 input-group-sm">
                                        ...
                                        <div class="form-group col-md-4 input-group-sm">
                                            <label for="EndDate">End Date<span style="color:red">*</span></label>
                                            <input type="date" class="form-control" id="EndDate" value="{{ strftime('%Y-%m-%d',strtotime($education['end_date'])) }}" name="end_date" required >
                                          </div>
                                      </div>
                                  ...
                                  <button type="button"  class="close remove-btn-reference"  aria-label="Clone" title="Remove Character Reference" onclick="remove_reference(this)">
                                    <span aria-hidden="true" class="btn-remove" ><i class="fas fa-minus-circle"></i></span>
                                        ...
                                        <div class="form-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control" value="{{ $characterRefrence->name ?? '' }}" id="Name" name="name[]" placeholder="">
                                        </div>
                                      <div class="form-group input-group-sm">
                                        <label for="Email">Email<span style="color:red">*</span></label>
                                        <input type="email" class="form-control" id="Email" value="{{ $characterRefrence->email ?? '' }}"  name="email[]" placeholder="">
                                      </div>
                                      <div class="form-group input-group-sm">
                                        <label for="CompName">Company Name<span style="color:red">*</span></label>
                                        <input type="text" class="form-control" id="CompName"  name="company_name[]" value="{{ $characterRefrence->company_name ?? '' }}" placeholder="">
                                      </div>
                                      <div class="form-group input-group-sm">
                                        <label for="Designation">Designation<span style="color:red">*</span></label>
                                        <input type="text" class="form-control" id="Designation"  name="designation[]" value="{{ $characterRefrence->designation ?? '' }}" placeholder="">
                                      </div>
