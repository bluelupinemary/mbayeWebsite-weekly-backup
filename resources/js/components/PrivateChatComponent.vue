                        ...
                        <div class="tab-content">
                            ...
                            <div id="discussions" class="tab-pane fade in active show">
                                ...
                                <div class="list-group sort">
                                    <a href="/privatechat" class="btn filterDiscussionsBtn active show" data-filter="all">Private</a>
                                    <a href="/groupchat" class="btn filterDiscussionsBtn" data-filter="read">Groups</a>
