                ...
                <div class="container">
                    <div class="inside">
                        <div class="nav nav-tab menu">
                            ...
                            <a href="/privatechat" data-toggle="tab" title="All members">
                                <i class="ti-home"></i>
                                Chats
                            </a>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="discussions" class="tab-pane fade in active show">
                                ...
                                <div class="list-group sort">
                                    <a href="/privatechat" class="btn filterDiscussionsBtn" data-filter="all">Private</a>
                                    <a href="/groupchat" class="btn filterDiscussionsBtn active show" data-filter="read">Groups</a>
                                        ...
                                        <div class="inside">
                                            <div class="panel">
                                                <div class="participant">
                                                    <img class="avatar-xxl" src="front/images/chat/avatars/avatar-female-5.jpg" alt="avatar">
                                ...
                                <div class="container">
                                    <div class="col-md-12">
                                        <div class="inside">
                                            <div class="panel">
                                                <div class="participant">
                                                    <img class="avatar-xxl" src="front/images/chat/avatars/avatar-female-2.jpg" alt="avatar">
                                                    <span>Connecting to sarah</span>
                                                    <div class="wave">
                                                        <span class="dot"></span>
                                                        <span class="dot"></span>
...
<script>
    export default {
        ...
        methods: {
            ...
            fetchgroups(id) {
            axios.get('/chatgroups').then(response => {
