     ...
     <div class="collage-editor">
            ...
            <div class="canvas">
             ...
             <div class="editor-controls">
                ...
                <!-- <button id="cropImage" disabled class="cropImage"><i class="fa fa-crop" data-toggle="tooltip" data-placement="top" title="Crop Image"></i></button>  -->
    ...
    //    console.log(this.in_page);
       ...
       //if the text created is unselected
        ...
        function applyFont(font) {
         ...
         document.querySelector('#font-picker').onchange = function handleImage(e) {
