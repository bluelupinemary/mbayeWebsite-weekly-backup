            ...
            <template v-if="this.blogs.total != 0">
                <div v-for="(blog,index) in blogs" :key="index" class="blog-col" ontouchstart="this.classList.toggle('hover');">
                    <div v-if='!blog.shared' class="container">
                        <div v-if="blog.nearexpire" class="front nearly-expired" :style="getimage(blog.featured_image)">
                            <div class="inner">
                        ...
                        <div v-else-if="!blog.nearexpire" class="front" :style="getimage(blog.featured_image)">
                            <div class="inner">
                                <span v-if="blog.status == 'Published'" class="blog-status published">{{blog.status}}</span>
                                <span v-else class="blog-status draft">{{blog.status}}</span>
                                <span v-if="blog.publish_datetime != ''" class="blog-date">{{blog.formatted_time}}</span>
                        ...
                        <div v-if="blog.nearexpire" class="back nearly-expired">
                            <div class="inner">
                        ...
                        <div v-else-if="!blog.nearexpire" class="back">
                            <div class="inner">
                                <div class="blog-action-buttons">
                                    <a :href="'/single_general_blog/' +blog.id"><img src="front/images/blog-buttons/view-btn.png" alt="" class="view-btn"></a>
                                    <a class="delete" @click.prevent="deleteblog(blog)"><img src="front/images/blog-buttons/delete-btn.png" alt="" class="delete-btn"></a>
                    ...
                    <div v-else-if='blog.shared' class="container">
                        <template v-if="blog.nearexpire">
                            <div class="front shared-blog nearly-expired" :style="getsharedimage(blog)">
                                <div class="inner">
                            ...
                            <div class="back shared-blog nearly-expired">
                                <div class="inner">
                                    <div class="blog-action-buttons">
                        ...
                        <template v-else-if="!blog.nearexpire">
                            ...
                            <div class="back shared-blog">
                                <div class="inner">
                                    <div class="blog-action-buttons">
                                        <a :href="'/shared_story/' +blog.id"><img src="front/images/blog-buttons/view-btn.png" alt="" class="view-btn"></a>
                                        <a class="delete" @click.prevent="deleteblog(blog)"><img src="front/images/blog-buttons/delete-btn.png" alt="" class="delete-btn"></a>
                                    <!-- <a :href="blog.editurl"><img src="front/images/blog-buttons/edit-btn.png" alt="" class="edit-btn"></a> -->
                                    </div>
                                </div>
