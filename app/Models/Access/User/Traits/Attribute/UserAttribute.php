...
trait UserAttribute
{
    ...
    public function getAstronaut()
    {
        $gender = $this->getGender();
        if($gender == 'female') {
            $astronaut = 'thomasina-navigator.png';
        } else {
            $astronaut = 'tom-navigator.png';
        }
    ...
    public function getAstronautHalf()
    {
        $gender = $this->getGender();
        if($gender == 'female') {
    ...
    public function getOriginalProfilePicture()
    {
        if(!is_null(access()->user()->photo)) {
            $filename = str_replace('-cropped', '', access()->user()->photo);
        } else {
            $filename = 'default.png';
        }
