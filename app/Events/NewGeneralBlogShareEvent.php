...
class NewGeneralBlogShareEvent implements ShouldBroadcast
{
     ...
     * @return void
     */
    public function __construct(GeneralBlogShare $shared_blog)
    {
    ...
    {
        return new Channel('new_general_blog_share');
    }
